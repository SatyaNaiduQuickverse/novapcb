...
DSN_RAW = os.path.join(HERE, "mot12_routing_raw.dsn")
DSN = os.path.join(HERE, "mot12_routing.dsn")
SES = os.path.join(HERE, "mot12_routing.ses")
LOG = os.path.join(HERE, "mot12_routing_freerouting.log")
