...
DSN_RAW = os.path.join(HERE, "microsd_routing_raw.dsn")
DSN = os.path.join(HERE, "microsd_routing.dsn")
SES = os.path.join(HERE, "microsd_routing.ses")
LOG = os.path.join(HERE, "microsd_routing_freerouting.log")
JAVA = os.path.expanduser("~/local/jre/jdk-25.0.3+9-jre/bin/java")
JAR = os.path.expanduser("~/local/freerouting/freerouting.jar")

CAN_NETS = {"SDMMC1_CLK","SDMMC1_CMD","SDMMC1_D0","SDMMC1_D1","SDMMC1_D2","SDMMC1_D3"}
