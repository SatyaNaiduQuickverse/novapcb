...
DSN_RAW = os.path.join(HERE, "d4_core_raw.dsn")
DSN = os.path.join(HERE, "d4_core.dsn")
SES = os.path.join(HERE, "d4_core.ses")
LOG = os.path.join(HERE, "d4_core_freerouting.log")
JAVA = os.path.expanduser("~/local/jre/jdk-25.0.3+9-jre/bin/java")
JAR = os.path.expanduser("~/local/freerouting/freerouting.jar")

TARGET_NETS = {"VCAP1","+3V3A","VREF_P","VBAT","BOOT0"}
