...
| Time (UTC) | Event |
|---|---|
| 2026-05-26 ~01:00 | **PR #107 T3 PARTIAL MERGED (sha b833073) — FLIGHT-CRITICAL MILESTONE.** MOT3-6 routed B.Cu-primary (the reframe that cracked what F.Cu corridor-redesign couldn't — failed twice 148/49 DRC). Freerouting converged 38s. v1 board now has 6/8 functional motor outputs = full quad/hex capability per Sai option D. Worker self-dispatched to IMU slot survey #50 per Rule 21. |
