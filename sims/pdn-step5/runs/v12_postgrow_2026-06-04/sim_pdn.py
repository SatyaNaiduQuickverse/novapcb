...
# +3V3 plane-pair cap (In3 +3V3 / In4 GND): A ~ 0.105*0.100*0.7 m^2 (grown board 105×100, 2026-06-04), d ~ 0.15mm, er 4.3
EPS0 = 8.854e-12
PLANE_C = EPS0 * 4.3 * (0.105 * 0.100 * 0.7) / 0.15e-3   # 105×100 grown board ~ farads
