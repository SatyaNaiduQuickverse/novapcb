...
BOARD_L = 0.105   # X long axis (was 0.062 → +37%)
BOARD_W = 0.100   # Y short axis (was 0.042 → +48%)
...
HEAT_SOURCES = {
    # Updated 2026-06-04 for board-grow 105×100 PCB (positions extracted from
    # novapcb-stepwise.kicad_pcb @ HEAD 431019e)
    "U2_buck": {"x_mm": 24.00, "y_mm": 25.00, "footprint_mm": (3.0, 3.0),  "power_W": 0.124},  # TPS62177 25mW × eff loss
    "U1_MCU":  {"x_mm": 45.00, "y_mm": 35.00, "footprint_mm": (14.0, 14.0), "power_W": 0.700},
    "U6_eFuse": {"x_mm": 28.00, "y_mm": 18.00, "footprint_mm": (3.0, 4.0),  "power_W": 0.018},
    "U13_LDO": {"x_mm": 60.00, "y_mm": 26.00, "footprint_mm": (3.0, 3.0),  "power_W": 0.050},
    "U14_CAN": {"x_mm": 94.00, "y_mm": 22.00, "footprint_mm": (3.5, 3.5),  "power_W": 0.100},
    "Q2_PFET": {"x_mm": 23.13, "y_mm": 21.50, "footprint_mm": (3.0, 1.5),  "power_W": 0.0065},
}

# ---------- mesh ----------

# Hex mesh resolution — 2 mm per cell (~consistent with prior baseline)
N_X = 53    # 85 mm / 43 ≈ 2 mm per cell
N_Y = 50    # 62 mm / 31 = 2 mm per cell
