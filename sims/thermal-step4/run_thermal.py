...
# Board geometry (m)
BOARD_L = 0.062   # X long axis
BOARD_W = 0.042   # Y short axis
...
# Heat sources (W) and locations (m) — from PLACEMENT_REPORT §Zoning
HEAT_SOURCES = {
    "U2_LDO":  {"x_mm": 9.5,  "y_mm": 28.0, "footprint_mm": (2.5, 3.0),  "power_W": 0.595},
    "U1_MCU":  {"x_mm": 30.0, "y_mm": 20.0, "footprint_mm": (14.0, 14.0), "power_W": 0.700},
    # Others < 1% of total — folded into the model only if the LDO/MCU
    # case shows tight margin where the small sources tip the result.
    "U6_eFuse": {"x_mm": 11.0, "y_mm": 18.0, "footprint_mm": (3.0, 4.0),  "power_W": 0.018},
    "Q2_PFET":  {"x_mm": 10.0, "y_mm": 11.0, "footprint_mm": (3.0, 1.5),  "power_W": 0.0065},
}

# ---------- mesh ----------

# Hex mesh resolution
N_X = 31    # 62 mm / 31 = 2 mm per cell
N_Y = 21    # 42 mm / 21 = 2 mm per cell
N_Z = 4     # 1.6 mm / 4 = 0.4 mm per cell (4 layers)
