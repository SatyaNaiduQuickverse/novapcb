...
| 6 | External mag + GPS I²C/UART | HIGH (~93%) → HIGH (~95%) | Phase 2c 2026-05-20: locked to IST8310 (0x0E) + RM3100 (0x20), both on I²C ALL_EXTERNAL, both ROTATION_NONE with HAL_COMPASS_AUTO_ROT_DEFAULT 2. Dropped AP_COMPASS_PROBING_ENABLED (broad-probe). SOTA: 3-ref convergence on CUAV-Nora hwdef.dat:253-254, CUAV-X7:261-266, CarbonixF405:131. GPS UART bus assignment still inherited from MatekH743; specific I²C bus → GPS connector pin is Phase 4 layout. | 3.5 ✓, 6d, 6e |
