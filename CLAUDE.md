...
| Telem UART (J3 UART7) | yes | connector + ESD placed; routes v2-deferred per Sai 2026-06-02 α-pick | **Empirical wall (11 paths over 2 days)** — 105×85 4-attempt original + board grow 105×100 + UART7 PE7/PE8 re-pin + CRSF cleanup + BATT2 nudge: MCU west-bridge 6-month-routing saturated; all H743 UART pin alternates blocked (PA9/PA10 walled, PB6/PB7=I²C1, PB14/PB15=SPI2, PE0/PE1=used, PC6/PC7=same wall). See `docs/TELEM_FINAL_V2_DEFER.md`. | USB-CDC canonical per §2.1 |
